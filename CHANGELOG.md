...
* Bump dependabot/fetch-metadata from 2.4.0 to 2.5.0 by @dependabot[bot] in https://github.com/lara-zeus/dynamic-dashboard/pull/59
* fix: update Tabs component import in ZeusWidget.php.stub by @a7medKhalid in https://github.com/lara-zeus/dynamic-dashboard/pull/58

### New Contributors

* @a7medKhalid made their first contribution in https://github.com/lara-zeus/dynamic-dashboard/pull/58

**Full Changelog**: https://github.com/lara-zeus/dynamic-dashboard/compare/4.0.3...4.0.4

## 4.0.3 - 2025-12-09

### What's Changed

* set user when creating a new layout by @atmonshi in https://github.com/lara-zeus/dynamic-dashboard/pull/57

**Full Changelog**: https://github.com/lara-zeus/dynamic-dashboard/compare/4.0.2...4.0.3
...
* Bump dependabot/fetch-metadata from 2.3.0 to 2.4.0 by @dependabot in https://github.com/lara-zeus/dynamic-dashboard/pull/48
* fix creating a new dashboard by @atmonshi in https://github.com/lara-zeus/dynamic-dashboard/pull/49

**Full Changelog**: https://github.com/lara-zeus/dynamic-dashboard/compare/v3.0.4...v3.0.5
